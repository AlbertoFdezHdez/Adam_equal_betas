...
SLIMPAJAMA_DIR = Path(os.environ.get("SLIMPAJAMA_DIR", "data/slimpajama-raw")).expanduser()
OUTPUT_DIR = Path(os.environ.get("NANOGPT_DATA_DIR", "data/slimpajama")).expanduser()
